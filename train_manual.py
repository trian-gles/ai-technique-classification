...
if __name__ == "__main__":
    ...
    train_count = (len(filenames) // 5) * 4
    val_count = total_files // 10
    print(f"Training with {train_count} training files, {val_count} validation files, and {len(filenames) - val_count - train_count} test files")
